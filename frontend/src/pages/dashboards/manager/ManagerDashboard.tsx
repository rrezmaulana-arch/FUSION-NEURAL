  ...
  return (
    <div className="space-y-6 pb-10">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <motion.div id="mgr-performance" initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.2 }} className="bg-[#0f172a] rounded-[32px] p-8 border border-white/10 flex flex-col">
        ...
        <motion.div id="mgr-performers" initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.3 }} className="bg-[#0f172a] rounded-[32px] p-8 border border-white/10 relative">
