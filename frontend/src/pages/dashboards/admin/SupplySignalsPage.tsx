...
export default function SupplySignalsPage() {
  ...
  return (
    <div className="space-y-6 pb-10">
      ...
      {/* Active Signals */}
      <div id="signal-feed" className="space-y-3">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        {/* Trend Correlation */}
        <div id="signal-trends" className="lg:col-span-2 bg-white rounded-2xl p-6 border border-slate-100 shadow-sm">
        ...
        <div className="space-y-6">
          ...
          <div id="signal-health" className="bg-white rounded-2xl p-6 border border-slate-100 shadow-sm flex flex-col items-center justify-center">
