  ...
  return (
    <div className="space-y-6 text-slate-300">
      <div className="bg-purple-900/30 rounded-2xl p-5 border border-purple-700/50">
        <h3 className="text-sm font-black text-purple-400 uppercase tracking-widest mb-2">Financial Vault</h3>
      ...
      <div className="space-y-4">
        ...
        <div className="flex items-start gap-4 p-4 rounded-xl hover:bg-slate-800/50 transition-colors border border-transparent hover:border-slate-700">
          ...
          <div>
            ...
            <p className="text-xs text-slate-400 leading-relaxed">Melacak "Burn Rate" perusahaan. Berapa biaya token AI yang dihabiskan Groq, biaya server, dll. Memastikan Anda tidak overbudget.</p>
          </div>
        </div>
