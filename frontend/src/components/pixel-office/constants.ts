...
export const WANDER_PAUSE_MAX_SEC = 3.5;
export const WANDER_MOVES_BEFORE_REST_MIN = 1;   // return to desk more often
export const WANDER_MOVES_BEFORE_REST_MAX = 3;
export const SEAT_REST_MIN_SEC = 5.0;             // sit and type for 5-12s
export const SEAT_REST_MAX_SEC = 12.0;
...
export const GRID_LINE_COLOR = 'rgba(255,255,255,0.02)';
...
// ── Speech Bubbles ───────────────────────────────────────────
export const SPEECH_BUBBLE_DURATION_SEC = 3.5;

// ── Social Interactions ─────────────────────────────────────
/** Tile-distance at which two wandering characters may start chatting */
export const SOCIAL_INTERACT_RANGE_TILES = 5;
/** Minimum seconds between two characters socialising */
export const SOCIAL_COOLDOWN_SEC = 2.0;
/** Probability of triggering a chat when proximity is detected (per second) */
export const SOCIAL_INTERACT_CHANCE_PER_SEC = 2.0;
