  ...
  return (
    <div className="space-y-6">
      <div className="bg-white rounded-3xl p-6 shadow-sm border border-slate-100 mb-8">
        ...
        <p className="text-sm text-slate-500">Logistics and operational backbone monitoring via AI Admin.</p>
      </div>

      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        <div className="bg-white rounded-3xl p-6 shadow-sm border border-slate-100">
          <div className="flex items-center justify-between mb-4">
            <h3 className="text-slate-500 font-medium text-sm">System Status</h3>
            <div className="p-2 bg-slate-50 rounded-lg"><Server className="w-5 h-5 text-emerald-500" /></div>
          </div>
          <div className="text-3xl font-bold text-slate-800">Online</div>
        </div>
        <div className="bg-white rounded-3xl p-6 shadow-sm border border-slate-100">
          <div className="flex items-center justify-between mb-4">
        ...
        <div className="bg-white rounded-3xl p-6 shadow-sm border border-slate-100">
          <div className="flex items-center justify-between mb-4">
            ...
            <div className="p-2 bg-slate-50 rounded-lg"><Shield className="w-5 h-5 text-emerald-500" /></div>
          </div>
      ...
      >
        <h3 className="font-bold text-slate-800 mb-4">Recent Server Logs</h3>
          ...
          {[1, 2, 3].map((i) => (
            <div key={i} className="flex items-center justify-between p-4 rounded-2xl bg-slate-50">
              <div className="flex items-center gap-3">
                ...
                <div>
                  <div className="font-medium text-slate-700">Database Sync Completed</div>
                  <div className="text-xs text-slate-400">Main Node • 2 mins ago</div>
                </div>
              </div>
              <div className="text-sm text-slate-500">200 OK</div>
            </div>
          ))}
        </div>
      </motion.div>
